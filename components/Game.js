...
<div style={t_styles}>
<button onClick={() => changeText_y("You get the offered money! Click below to PLAY AGAIN")}>{buttonText_y}</button>
<button onClick={() => changeText_n("You and the dictator get nothing!  Click below to PLAY AGAIN")}>{buttonText_n}</button>
</div>
<div style={pa_styles}>
